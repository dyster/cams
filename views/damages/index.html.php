...
<table>
	<thead>
		<tr>
			<th style="width: 100px;">Inlagd</th><th style="width: 20px;">Prio</th><th>Fordon</th><th>Grupp</th><th>Skada</th><th>Inlagd av</th>
		</tr>
	</thead>
...
<table>
	<thead>
		<tr>
			<th style="width: 100px;">Inlagd</th><th style="width: 20px;">Prio</th><th>Fordon</th><th>Grupp</th><th>Skada</th><th>Ändrad av</th>
		</tr>
	</thead>
	...
	<?php } ?>	
	<tfoot>
		<tr><td colspan="6">Visa <?php foreach($antal as $a) echo $this->html->link($a, "/damages/index/20/$a/20").' '; ?></td></tr>
	</tfoot>
</table>
...
<table>
	<thead>
		<tr>
			<th style="width: 100px;">Inlagd</th><th style="width: 20px;">Prio</th><th>Fordon</th><th>Grupp</th><th>Skada</th><th style="width: 100px;">Kvitterad</th><th>Av</th>
		</tr>
	</thead>
	...
	<?php } ?>	
	<tfoot>
		<tr><td colspan="7">Visa <?php foreach($antal as $a) echo $this->html->link($a, "/damages/index/20/20/$a").' '; ?></td></tr>
	</tfoot>
</table>
