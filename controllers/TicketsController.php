...
class TicketsController extends \lithium\action\Controller {
	...
	public function view($id) {
		...
		$comments = Tickets_comments::all(array('conditions' =>array('ticket_id' => $id), 'order' => 'created DESC'));
	...
	public function delete($id) {
		...
		if($ticket->user_id != $_SESSION['user']['id'])
		{
			FlashMessage::Write('Du kan endast avsluta dina egna ärenden', array('class' => 'fail'));
