<h2>Arkiv för <?php echo $h($object->ToString()); ?></h2>
...
<?php foreach($damages as $damage) { ?>
	...
	<table style="<?php switch($damage->prio)
	{
		...
		<tr>
			<td>Kvitterad</td><td><?php echo $h(substr($damage->nulled, 0 ,16)); ?> av <?php echo $h($damage->getNulledBy()->fullname); ?> </td>	
		</tr>
		<tr>
			<td>Åtgärd</td><td><?php echo $h($damage->nulltext); ?></td>
		</tr>
