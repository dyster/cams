...
{ ?>
	<tr>
    	<td><?php echo $h(substr($object->getPrio1Date(),0,10)); ?></td><td><?php echo $h($object->getPrio1Location()); ?></td><td><?php echo $h($object->getType()->name); ?></td><td><?php echo $this->html->link($object->name, 'objects/view/'.$object->id); ?></td><td><?php echo $h($object->getOwner()->name); ?></td>
    </tr>
<?php } ?>
	<tfoot>
...
{ ?>
	<tr>
    	<td><?php echo $h(substr($object->created,0,10)); ?></td><td><?php echo $h($object->getType()->name); ?></td><td><?php echo $this->html->link($object->name, 'objects/view/'.$object->id); ?></td><td><?php echo $h($object->getOwner()->name); ?></td>
    </tr>
<?php } ?>
	<tfoot>
